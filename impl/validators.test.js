...
describe('validateEncryptionParams:', () => {
    ...
    describe('cipher type validation', () => {
        it('rejects on non-string cipherType', () => {
            expect(validators.validateEncryptionParams(validInput, validPassword, 123))
                .rejects.toBeTruthy();
            expect(validators.validateEncryptionParams(validInput, validPassword, {}))
                .rejects.toBeTruthy();
            expect(validators.validateEncryptionParams(validInput, validPassword, [1,2,3]))
                .rejects.toBeTruthy();
        });

        it('rejects on unknown cipherType', () => {
            expect(validators.validateEncryptionParams(validInput, validPassword, 'aes123'))
                .rejects.toBeTruthy();
        });

        it('resolves as undefined for aes128, aes256 and blowfish', () => {
            expect(validators.validateEncryptionParams(validInput, validPassword, 'aes128'))
                .resolves.toBe(undefined);
            expect(validators.validateEncryptionParams(validInput, validPassword, 'aes256'))
                .resolves.toBe(undefined);
            expect(validators.validateEncryptionParams(validInput, validPassword, 'blowfish'))
                .resolves.toBe(undefined);
        });
    });
});
...
describe('validateDecryptionParams:', () => {
    it('rejects on empty input', () => {
        expect(validators.validateDecryptionParams(validInput, '', validPassword, 'aes256'))
            .rejects.toBeTruthy();
        expect(validators.validateDecryptionParams(validInput, null, validPassword, 'aes256'))
            .rejects.toBeTruthy();
    ...
    it('rejects on non-string input', () => {
        expect(validators.validateDecryptionParams(validInput, 123, validPassword, 'aes256'))
            .rejects.toBeTruthy();
    });
